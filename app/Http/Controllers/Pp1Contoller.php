...
class Pp1Contoller extends Controller
{
    /**
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return redirect()->route('grade1.show', $playground->id);
        }
    }
     public function destroy(string $id)
    {
        $grade12 = grade1::findOrFail($id);
        $grade12->delete();
    
        return redirect()->route('grade1.index');
    }
    ...
    public function showPlaygroundByClassId($classId)
    {
        ...
        $grade12 = Playground::where('class_id', $classId)->get();
